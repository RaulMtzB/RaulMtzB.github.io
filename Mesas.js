...
function ActualizaMeseros() {
    ...
    function ActualizaSeleccionMeseros() {
        ...
        for (let i = 0; i < SelecMesero.length; i++) {
            console.log("entra");
            (function (index) {
        ...
        for (var i = 0; i < SelecAsiento.length; i++) {
            ...
            (function (index) {
                document.getElementsByName("AsientoQR")[index].addEventListener("click", function () {
                    ...
                    console.log("clicked URL:" + document.getElementsByName('URLQR')[index].innerHTML);
                    document.getElementById("QrImprimible").src = document.getElementsByName('URLQR')[index].innerHTML;
                })
